...
7.  Событие должно быть необычным, жестким, допускается черный юмор.
   С вероятностью 50% допускается пошлый или неловко-интимный элемент (но без откровенной порнографии).
8.  Никакой вариативности формулировок. Все изменения должны быть четкими и конкретными.

=== ФОРМАТ ОТВЕТА ===

3-4 предложений художественного описания.

Затем отдельным блоком:

Последствия:
- Имя игрока: конкретное изменение здоровья
- Имя игрока: новая фобия (если есть)
- Инвентарь: ...
- Запас еды: +X месяцев / -X месяцев / +X лет / -X лет
- Бункер: изменение (если есть)
