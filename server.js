...
const GAME_DATA = {
  ...
  bunkers: [
    ...
    },
    {
      "duration_years": 6,
      "food_years": 4,
      "extra": "Бункер банка, предназначенный для хранения ценностей и сотрудников. Толстенные стены, герметичные двери, автономная система жизнеобеспечения. Есть запас еды и воды, но очень мало места и душно."
    },
    {
      "duration_years": 7,
      "food_years": 5,
    ...
    },
    {
      "duration_years": 5,
      "food_years": 4,
      "extra": "Бункер на территории секретной лаборатории. Полная автономия, системы очистки. Есть лаборатория и медотсек, но постоянный риск утечки опасных веществ."
    },

    {
      "duration_years": 5,
      "food_years": 4,
      "extra": "Бывший командный пункт стратегической авиации. Глубоко под землёй, трёхметровые железобетонные стены, герметичные двери, автономная дизельная электростанция с запасом топлива на 2 года. Есть собственная артезианская скважина. В сейфе обнаружены полётные карты, два пистолета Макарова и ящик с патронами."
    },
    {
      "duration_years": 6,
      "food_years": 4,
      "extra": "Убежище в скальном массиве, вырубленное при строительстве железнодорожного тоннеля. Естественная защита, геотермальное отопление, подземное озеро с питьевой водой. В тайнике среди породы найдены альпинистское снаряжение, верёвки и ящик с динамитом."
    },
    {
      "duration_years": 4,
      "food_years": 3,
      "extra": "Переоборудованная шахта по добыче известняка. Просторные залы, система вентиляции через старые стволы, оборудована мастерская с токарным станком. В сейфе горного мастера — набор слесарных инструментов и несколько килограммов взрывчатки."
    },
    {
      "duration_years": 3,
      "food_years": 2,
      "extra": "Бункер гражданской обороны, законсервированный с советских времён. Трёхметровые стены, фильтровентиляционная установка, дизель-генератор. В сейфе начальника убежища найдены мощная рация, комплект медикаментов и противогазы."
    },
    {
      "duration_years": 7,
      "food_years": 5,
      "extra": "Подземный исследовательский центр в вечной мерзлоте. Геотермальное отопление, полная автономия, лаборатория с микроскопами и хирургическими инструментами. В сейфе полярников — арктическая одежда, унты и спутниковый телефон."
    },
    {
      "duration_years": 5,
      "food_years": 4,
      "extra": "Бывшая станция метро глубокого заложения, отсечённая гермозатворами. Огромные пространства, есть доступ к подземным водам. В кабинете начальника станции обнаружены планы города, инструменты и несколько раций."
    },
    {
      "duration_years": 4,
      "food_years": 3,
      "extra": "Бункер на территории бывшего ракетного училища. Толстые стены, казармы, учебные классы, мастерские. В сейфе преподавателя — учебные автоматы, ящик с патронами и оптические прицелы."
    },
    {
      "duration_years": 6,
      "food_years": 4,
      "extra": "Подземный гараж для спецтехники, переоборудованный в убежище. Мощные бетонные перекрытия, въезд перекрыт гермоворотами. В сейфе механика — сварочный аппарат, баллоны с газом, тепловизор и набор автозапчастей."
    },
    {
      "duration_years": 5,
      "food_years": 4,
      "extra": "Научная станция в горах, переоборудованная в убежище. Геотермальное отопление, обсерватория (оборудование не работает), есть коротковолновая радиостанция. В сейфе метеорологов — тёплая одежда, альпинистское снаряжение и бинокли."
    },
    {
      "duration_years": 4,
      "food_years": 3,
      "extra": "Бывший склад военной техники в скале. Ангары для машин, мастерские, принудительная вентиляция. В сейфе кладовщика — несколько автоматов Калашникова, ящик с патронами и приборы ночного видения."
    },

    {
      "duration_years": 3,
      "food_years": 1,
      "extra": "Бывший командный пункт ПВО, заброшенный в 90-х. Толстые железобетонные стены, герметичные двери, есть дизель-генератор, но топлива всего на полгода. В одной из комнат найден сейф с тремя автоматами Калашникова и ящиком патронов. Сырость и плесень в жилых отсеках, постоянный запах машинного масла."
    },
    {
      "duration_years": 2,
      "food_years": 1.2,
      "extra": "Подвал старой городской библиотеки, переоборудованный под убежище. Книжные стеллажи служат дополнительной изоляцией, есть печка-буржуйка и запас дров на год. В сейфе библиотекаря обнаружены карты окрестностей и несколько раций с ручным приводом. Нет водопровода — приходится собирать дождевую воду, крыша протекает во время дождей."
    },
    {
      "duration_years": 4,
      "food_years": 1.5,
      "extra": "Подземный гараж-стоянка, герметизированный жильцами соседних домов. Въезд перекрыт бетонными плитами, есть несколько машин с остатками бензина и сварочный аппарат. В сейфе, найденном в сторожке, лежат инструменты и набор слесарных принадлежностей. Вентиляция слабая, запах выхлопных газов, шумно из-за близости метро."
    },
    {
      "duration_years": 3,
      "food_years": 0.8,
      "extra": "Бункер, построенный фанатами выживания в гараже. Укреплён металлическими листами, хорошая теплоизоляция и самодельный ветряк, дающий свет. В сейфе под половицей обнаружены охотничье ружьё и патроны. Маленькая площадь, теснота."
    },
    {
      "duration_years": 5,
      "food_years": 1,
      "extra": "Заброшенный бункер железнодорожного тоннеля. Огромное пространство, можно развести огород на гидропонике. Есть дизель-генератор и цистерна солярки, но она старая. В сейфе диспетчерской найдены рации и тепловизор. Постоянный гул от проходящих поездов (если они ещё ходят) и сквозняки."
    },
    {
      "duration_years": 2,
      "food_years": 1.3,
      "extra": "Убежище в старом винном погребе. Каменные своды, постоянная температура +10. В сейфе хозяина — коллекция старинного оружия (шпаги, кинжалы) и несколько пистолетов. Нет электричества, слабая вентиляция, запах сырости и плесени."
    },
    {
      "duration_years": 3,
      "food_years": 1,
      "extra": "Бывшая столовая завода, переделанная в убежище рабочими. Бетонные стены, большая кухня с газовыми баллонами. В сейфе начальника цеха — инструменты и чертежи оборудования. Негерметичные окна, зимой холодно, требуется постоянная топка печи."
    },
    {
      "duration_years": 4,
      "food_years": 5,
      "extra": "Подземный бункер на территории детского лагеря. Есть спальные комнаты, дизельная. В сейфе вожатой медикаменты и аптечка с антибиотиками. Плохая звукоизоляция, слышны шаги наверху, система вентиляции требует ремонта."
    },
    {
      "duration_years": 4,
      "food_years": 3,
      "extra": "Пещера в скале, оборудованная альпинистами. Естественная защита, подземное озеро с чистой водой. Нет отопления, зимой холодно, вход нужно маскировать."
    },
    {
      "duration_years": 3,
      "food_years": 2,
      "extra": "Бункер коллекционера-милитариста. Стены увешаны флагами и плакатами, есть арсенал (несколько винтовок, пистолетов, ящик патронов). Теснота, захламлённость, плохая вентиляция."
    },
    {
      "duration_years": 5,
      "food_years": 1.2,
      "extra": "Подземный склад сельхозтехники. Огромное помещение, есть трактор и запасы солярки. В сейфе кладовщика — запчасти и инструменты. Есть возможность выращивать овощи под лампами. Холодно (нет отопления), сыро, требуется ремонт крыши."
    },
    {
      "duration_years": 2,
      "food_years": 2,
      "extra": "Убежище в бывшем бомбоубежище школы. Прочные стены, герметичные двери, фильтровентиляция работает, но шумно. В сейфе директора — документация и ключи от всех кабинетов, а также ящик с учебными пособиями по выживанию. Плесень в спортзале, холодные полы."
    },
    {
      "duration_years": 3,
      "food_years": 2,
      "extra": "Переоборудованный подземный тир. Есть хорошая вентиляция, запасы патронов и мишеней. В сейфе инструктора — несколько пистолетов и оптические прицелы. Постоянный запах пороха, сырость, требует ремонта освещение."
    },
    {
      "duration_years": 4,
      "food_years": 4,
      "extra": "Бункер на территории заброшенной фермы. Стены из бетонных блоков. В сейфе хозяина — охотничьи ружья и капканы. Нет электричества, печное отопление требует дров, которые надо заготавливать."
    },
    {
      "duration_years": 2,
      "food_years": 1,
      "extra": "Подземный бункер на кладбище. Толстые стены, есть дизель-генератор. В сейфе смотрителя — инструменты и запасные лампы. Атмосфера давящая, многие не выдерживают психологически, постоянный страх."
    }
  ...
  characteristics: {
    ...
    extras: [
      ...
      'Угнал(а) автомобиль',
      'Вымогал(а) деньги',
      'Занималась(-ся) проституцией',
      'Снималась(-ся) в фильмах для взрослых',
      'Работал(а) в эскорте',
      'Бил(а) супругу(-а)',
      'Бил детей',
      'Бросил(а) семью',
      'Крал(а) у сослуживцев',
      'Доносил(а) на коллег',
      'Подставлял(а) друзей',
      'Спал с чужой женой',
      'Спал с чужим мужем',
      'Изнасилован(а) в юности',
      'Эксгибиционист',
      'Подглядывал(а) за соседями',
      ...
      'Посещал(а) свингер-клубы',
      'Участвовал(а) в оргиях',
      'Имел(а) опыт групповых отношений',
      'Спал с начальником',
      'Спал с начальницей',
      'Изменял(а) супругу',
      'Изменяла жене',
      'Имел(а) любовника',
      'Имел(а) любовницу',
      'Был интим с животным',
      'Был опыт с трупом',
      'Был интим с несовершеннолетними',
      'Был интим с братом',
      'Был интим с сестрой',
      'Был интим с родителями',
      'Фут-фетишист',
      'БДСМ-мазохист',
      'БДСМ-садист',
      'Эксгибиционист',
    ...
    professions: [
      ...
      { name: 'Психолог', description: 'Может узнать черту характера выбранного игрока' },
      ...
      { name: 'Астроном', description: 'Если получает негативные последствия в ходе события, то может их отменить 1 раз для себя' },
      { name: 'Сплетник', description: 'Может подговорить голосовать против выбранного игрока 1 раз' },
      { name: 'Телохранитель', description: 'Умеет обращаться с оружием, может защитить игрока от голосования 1 раз' },
      ...
      { name: 'Экстрасенс', description: 'Может узнать доп. сведения о любом игроке' },
      { name: 'Таролог', description: 'Раскрывает черту характера или фобию выбранного игрока' },
      ...
      { name: 'Фитнес-транер', description: 'Может изменить телосложение любого игрока на Атлетичное' },
    ]
  }
};
...
const ABILITY_LIST = [
  { value: "Оперативное вмешательство: изменить степень тяжести любой болезни у одного игрока на 1 (улучшить или ухудшить)", includeInFinal: false },
  { value: "Общая диагностика: раскрыть состояние здоровья любого игрока", includeInFinal: false },
  { value: "Сеанс психотерапии: раскрыть фобию другого игрока и один раз за игру вылечить её (нельзя применить к себе)", includeInFinal: false },
  { value: "Общий наркоз: выбранный игрок пропускает ход и голосование", includeInFinal: false },
  { value: "Сыворотка: добавляет себе в инвентарь вакцину от вируса", includeInFinal: true },
  { value: "Укрепление иммунитета: повышает сопротивляемость игрока ко всем имунно-инфекционным болезням и излечивает себя от них", includeInFinal: true },
  { value: "Орлиный глаз: позволяет игроку найти скрытые ресурсы или улики в локации (+6 мес. еды)", includeInFinal: true },
  { value: "Нашествие крыс: уменьшает запас еды в бункере на 6 месяцев", includeInFinal: false },
  { value: "Дезинфектор: обеззараживает предметы или ресурсы", includeInFinal: true },
  { value: "Любовный союз: связывает двух игроков — они не могут голосовать друг против друга 2 раунда", includeInFinal: false },
  { value: "Дефибриллятор: один раз за игру может вернуть к жизни игрока, умершего в этом раунде", includeInFinal: false },
  { value: "Ремонтный набор: чинит сломанное оборудование в бункере или предмет в инвентаре", includeInFinal: true },
  { value: "Восстановление сети: возвращает электроснабжение, открывая доступ к электронным системам", includeInFinal: true },
  { value: "Силовое давление: заставляет игрока раскрыть одну скрытую характеристику или применить способность на нужную цель", includeInFinal: false },
  { value: "С чистого листа: сбрасывает все характеристики игроков и заменяет на новые", includeInFinal: false },
  { value: "Запугивание: запрещает выбранному игроку использовать способность против определённого игрока", includeInFinal: false },
  { value: "Фальсификация: меняет результат голосования на противоположный (можно применить после голосования)", includeInFinal: false },
  { value: "Прогноз погоды: предупреждает об опасных явлениях и выбирает безопасное окно для вылазок", includeInFinal: true },
  { value: "Картограф: знает месторасположение полезных ресурсов поблизости (водоемы, леса, пастбища, соседние бункеры)", includeInFinal: true },
  { value: "Укрепление убежища: повышает защиту бункера от внешних угроз", includeInFinal: true },
  { value: "Сабботаж: ломает важную систему бункера (вентиляция, электрика, генераторы, канализацию и т.д.)", includeInFinal: false },
  { value: "Ловкие пальчики: крадёт инвентарь у любого игрока", includeInFinal: false },
  { value: "Нападение зверя: на выбранного игрока нападает дикий зверь, игрок погибает с шансом 50%", includeInFinal: false },
  { value: "Барахольщик: рандомно изменяет свой инвентарь", includeInFinal: false },
  { value: "Наставничество: обучает игрока, временно повышая его стаж на 5 лет", includeInFinal: false },
  { value: "Переквалификация: случайным образом меняет свою профессию или другого игрока, но максимальный стаж - 1 год", includeInFinal: false },
  { value: "Переработка: вы научились перерабатывать отходы в энергию, которой хватит до конца времянахождения в бункере", includeInFinal: true },
  { value: "Глаз бога: раскрывает пол игрока", includeInFinal: false },
  { value: "Сплетничество: раскрывает доп. сведения любого игрока", includeInFinal: false },
  { value: "Неуязвимость: против вас нельзя использовать негативные способности и выгнать из бункера в течение текущего раунда", includeInFinal: false },
  { value: "Говорит с акцентом: до конца игры выбранный игрок общается с иностранным акцентом (по выбору обладателя способности)", includeInFinal: false },
  { value: "Заикание: в начале каждого предложения выбранный игрок заикается на первой букве в течение трёх секунд", includeInFinal: true },
  { value: "Шёпот: выбранный игрок может говорить только шёпотом в течение 2 раундов, настолько тихо, что другие игроки должны напрягать слух, чтобы его услышать", includeInFinal: false },
  { value: "Рифмоплёт: выбранный игрок обязан говорить только в рифму в течение 1 раунда, иначе молчать 2 раунда", includeInFinal: false },
  { value: "Туберкулёз: выбранный  игрок постоянно кашляет на протяжении 2х раундов, перебивая свою же речь, и не может закончить предложение без приступа", includeInFinal: false },
  { value: "Заразительный смех: когда выбранный игрок начинает говорить, он не может сдержать смех — в середине предложения он должен заливаться смехом минимум на 2 секунды", includeInFinal: true },
  { value: "Пикми: когда выбранный игрок отстаивает свою позицию, он должен говорить в стиле Пикми - до конца игры", includeInFinal: false },
  { value: "Зажатый нос: игрок зажимает нос пальцами и говорит гнусаво 2 раунда", includeInFinal: false },
  { value: "Заражение: добавляет в общий запас еды испорченный продукт — один случайный игрок отравится, если поест и погибнет с вероятностью 50%", includeInFinal: false },
  { value: "Ключ: добавляет себе в инвентарь ключ от сейфа", includeInFinal: true },
  { value: "Роковая связь: добавляет себе ВИЧ заболевание (тяжелая) и заражает выбранного игрока им же", includeInFinal: false },
  { value: "На всякий случай: добавляет себе в инвентарь пистолет с 12 патронами", includeInFinal: true },
  { value: "Месть: раскрывает местоположение вашего бункера соседним, из-за чего на вас регулярно совершаются набеги и необходимо защищаться", includeInFinal: true },
...
function buildFinalPrompt(game) {
  ...
  // Добавляем информацию об активированных скрытых способностях
  const activatedAbilities = [];
  game.players.forEach(player => {
    if (player.secretAbility && player.secretAbility.activated && player.secretAbility.includeInFinal) {
      activatedAbilities.push(`${player.name}: ${player.secretAbility.value}`);
    }
  });
  if (activatedAbilities.length > 0) {
    prompt += `\nАКТИВИРОВАННЫЕ СПОСОБНОСТИ:\n`;
    activatedAbilities.forEach(line => prompt += `  ${line}\n`);
  }
  ...
  prompt += `- Длина: от 30 до 60 предложений.\n`;
  prompt += `- Исход должен зависеть от раскрытых характеристик и активированных способностей: если характеристики бесполезны или вредны, группа может погибнуть (голод, болезни, конфликты). Если есть полезные навыки или способности – шансы на выживание выше.\n`;
  prompt += `- Используй имена игроков как в списке выше.\n`;
  prompt += `- Не добавляй информацию, которой нет в раскрытых характеристиках или активированных способностях.\n`;
...
io.on('connection', (socket) => {
  ...
  socket.on('randomizeDisaster', ({ gameId }) => {
    const game = games.get(gameId);
    if (!game) {
      socket.emit('error', 'Игра не найдена');
      return;
    ...
    if (!initiator || initiator.id !== game.creator) {
      socket.emit('error', 'Только создатель может менять катастрофу');
      return;
    }
    const newDisaster = GAME_DATA.disasters[Math.floor(Math.random() * GAME_DATA.disasters.length)];
    game.disaster = newDisaster;
    games.set(gameId, game);
    saveData();
    io.to(gameId).emit('disasterUpdated', { disaster: newDisaster });
    console.log(`Создатель ${initiator.name} изменил катастрофу (случайно) в игре ${gameId}`);
  });

  // Случайный бункер
  socket.on('randomizeBunker', ({ gameId }) => {
    const game = games.get(gameId);
    if (!game) {
      socket.emit('error', 'Игра не найдена');
      return;
    ...
    const initiator = game.players.find(p => p.socketId === socket.id);
    if (!initiator || initiator.id !== game.creator) {
      socket.emit('error', 'Только создатель может менять бункер');
      return;
    }
    const newBunker = GAME_DATA.bunkers[Math.floor(Math.random() * GAME_DATA.bunkers.length)];
    game.bunker = newBunker;
    games.set(gameId, game);
    saveData();
    io.to(gameId).emit('bunkerUpdated', { bunker: newBunker, totalSlots: game.totalSlots });
